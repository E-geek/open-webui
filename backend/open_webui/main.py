...
app.state.config.QUERY_GENERATION_SEARCH_PROMPT_TEMPLATE = QUERY_GENERATION_SEARCH_PROMPT_TEMPLATE
app.state.config.RAG_SEARCH_MODE = RAG_SEARCH_MODE
app.state.config.RAG_POINTWISE_OVERLAP = RAG_POINTWISE_OVERLAP
